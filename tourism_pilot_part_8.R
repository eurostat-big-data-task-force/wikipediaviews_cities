...
m <- leaflet(Bruges_C_final) %>%
  ...
  addCircleMarkers(data = Bruges_districts_items, ~long, ~lat, radius = ~log(value), stroke = F, fillColor = "#41ab5d", fillOpacity = 0.6, popup = ~link, options =markerOptions(opacity = 0), group = "Districts") %>%

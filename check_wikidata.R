...
Barcelona_C_cat_OCTOBER <- data.frame(item = character(), cat = character())
for (i in 1:nrow(test)) {
  ...
  temp <- item %>%
    mutate(cat = cat) 
  Barcelona_C_cat_OCTOBER <- rbind(Barcelona_C_cat_OCTOBER, temp)
}

Barcelona_C_cat_OCTOBER <- Barcelona_C_cat_OCTOBER%>%
  distinct(item, .keep_all = TRUE)
...
Barcelona_K_cat_OCTOBER <- data.frame(item = character(), cat = character())
for (i in 1:nrow(test)) {
  item <- data.frame(item = test$item[i])
  if (is.na(test$cat.y[i])) {
    cat <- test$cat.x[i]
  ...
  temp <- item %>%
    mutate(cat = cat) 
  Barcelona_K_cat_OCTOBER <- rbind(Barcelona_K_cat_OCTOBER, temp)
}

Barcelona_K_cat_OCTOBER <- Barcelona_K_cat_OCTOBER%>%
  distinct(item, .keep_all = TRUE)
...
Bruges_C_cat_OCTOBER <- data.frame(item = character(), cat = character())
for (i in 1:nrow(test)) {
  item <- data.frame(item = test$item[i])
  if (is.na(test$cat.y[i])) {
    cat <- test$cat.x[i]
  ...
  temp <- item %>%
    mutate(cat = cat) 
  Bruges_C_cat_OCTOBER <- rbind(Bruges_C_cat_OCTOBER, temp)
}

Bruges_C_cat_OCTOBER <- Bruges_C_cat_OCTOBER%>%
  distinct(item, .keep_all = TRUE)
...
Bruges_F_cat_OCTOBER <- data.frame(item = character(), cat = character())
for (i in 1:nrow(test)) {
  item <- data.frame(item = test$item[i])
  if (is.na(test$cat.y[i])) {
    cat <- test$cat.x[i]
  ...
  temp <- item %>%
    mutate(cat = cat) 
  Bruges_F_cat_OCTOBER <- rbind(Bruges_F_cat_OCTOBER, temp)
}

Bruges_F_cat_OCTOBER <- Bruges_F_cat_OCTOBER%>%
  distinct(item, .keep_all = TRUE)
...
Vienna_C_cat_OCTOBER <- data.frame(item = character(), cat = character())
for (i in 1:nrow(test)) {
  item <- data.frame(item = test$item[i])
  if (is.na(test$cat.y[i])) {
    cat <- test$cat.x[i]
  ...
  temp <- item %>%
    mutate(cat = cat) 
  Vienna_C_cat_OCTOBER <- rbind(Vienna_C_cat_OCTOBER, temp)
}

Vienna_C_cat_OCTOBER <- Vienna_C_cat_OCTOBER%>%
  distinct(item, .keep_all = TRUE)
